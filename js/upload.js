...
import {onFormInput, pristine } from './validation.js';
...
const effectsThumbnailsContainer = document.querySelector('.effects');
...
uploadButton.addEventListener('change', () => {
  ...
  uploadForm.addEventListener('input', onFormInput);
  uploadForm.addEventListener('submit', onFormSubmitClick);
  effectsThumbnailsContainer.addEventListener('change', onThumbnailEffectClick);
...
function closeModal () {
  ...
  uploadForm.removeEventListener('input', onFormInput);
  uploadModal.classList.add('hidden');
  document.body.classList.remove('modal-open');
  document.removeEventListener('keydown', onDocumentKeydown);
  uploadForm.removeEventListener('submit', onFormSubmitClick);
  effectsThumbnailsContainer.removeEventListener('change', onThumbnailEffectClick);
  resetScale();
  resetEffects();
}
